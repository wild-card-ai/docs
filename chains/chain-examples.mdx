...
This example shows how to chain operations across multiple services:
...
config = ChainConfig(
    ...
    nodes=[
        ...
        ChainNode(
            ...
            selectedAction=Action.GitHub.ISSUES_CREATE,
            fixedArgs={
                "owner": "your-org",
                "repo": "your-repo",
                "title": "Bug Report",
        ...
        ChainNode(
            ...
            prompt="Schedule a bug review meeting",
            toolIndex="google_calendar",
            selectedService="google_calendar",
            selectedAction=Action.GoogleCalendar.EVENTS_INSERT,
            fixedArgs={
                "summary": "Bug Review Meeting",
                "duration": "30m"
            }
        )
    ]
...
- Learn about [Chain Architecture](/chains/overview)
